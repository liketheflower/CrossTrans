...
data = dict(
    ...
    train=dict(
        ...
        img_prefix=
        '/data/sophia/a/Xiaoke.Shen54/DATASET/sunrgbd_DO_NOT_DELETE/train/dhs80/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True, with_mask=True),
            dict(type='RandomFlip', flip_ratio=0.5),
    ...
    val=dict(
        ...
        img_prefix=
        '/data/sophia/a/Xiaoke.Shen54/DATASET/sunrgbd_DO_NOT_DELETE/val/dhs80/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
...
resume_from = None
workflow = [('train', 1)]
work_dir = './work_dirs/mask_rcnn_swin-t-p4-w7_fpn_ms-crop-3x_coco_load_from_mask80'
gpu_ids = range(0, 1)
